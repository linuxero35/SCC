<div>
  ...
  <main class="d-flex flex-nowrap">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white " style="background-color:#203500; width: 280px;">
      <div class="container d-flex align-items-center justify-content-center">
        <!--  <span class="fs-4"><img src="../imagenes/logo.pg.jpg" style="width: 150px; height: 150px; " alt=""></span> -->
        <center>
          <span class="fs-4" style="font-size: 17px!important;"> Telebachillerato Comunitario N° 203 de Tejupilco. </span>
        </center>
      </div>
      <hr>
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item">
          <a href="../alumnos/captura.php" class="nav-link text-white" aria-current="page">
            <svg class="bi pe-none me-2" width="16" height="16">
              <use xlink:href="#home" />
            </svg>
            Capturar Alumno
