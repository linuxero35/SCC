  ...
  <div style="display: flex;">
    ...
    <div>
      <div class="container" style="background-color:#007b00; width: 100%; padding: 12px; box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px;">
        <center>
          <h1 style="color: white;">Consulta Usuarios </h1>
        </center>
      </div>
      <div class="container-fluid" style="width: 85%;">
        <div class="conatiner" style="margin: 11px; margin-bottom: 25px;"></div>
        <form class="row g-3" method="post" action="/SCC/controllers/usuarios/consultaController.php">
          <div id="datosPersonales" class="row g-3" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; padding-left:30px; padding-right:30px; padding-bottom: 30px; border-radius:8px;">
            ...
            <div class="col-md-6">
              ...
              <input type="text" maxlength="45" class="form-control" id="txtusuario" name="txtusuario" placeholder="">
            </div>
            <div class="col-md-6">
              <label for="inputAddress2" class="form-label">Nombre</label>
              <input type="text" maxlength="45" class="form-control" id="txtnombre" name="txtnombre" placeholder="" >
            </div>
            <div class="col-md-6">
              <label for="inputAddress2" class="form-label">Apellido Paterno</label>
              <input type="text" maxlength="45" class="form-control" id="txtap" name="txtap" placeholder="" >
            </div>
            <div class="col-md-6">
              <label for="inputAddress2" class="form-label">Apellido Materno</label>
              <input type="text" maxlength="45" class="form-control" id="txtam" name="txtam" placeholder="">
            </div>
          ...
          <tbody>
            ...
            if (isset($_SESSION["listaUsuarios"])) {
              foreach ($usuarios as $usuario) {
                ...
                echo " <tr>
    <th scope='row' style='text-align: center;'>" . $usuario['usuario'] . "</th>
    <td >" . $usuario['nombre'] . "</td>
    <td >" . $usuario['Activo'] . "</td>
    <td style='text-align: center;'><a href='../controllers/usuarios/editarController.php?IdUsuario=" . $usuario['IdUsuario'] . "'><img style='cursor:pointer;' src='../imagenes/editar.png' alt='editar'></a> </td>
